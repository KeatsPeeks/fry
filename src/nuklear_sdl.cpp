...
NuklearSdl::NuklearSdl(SDL_Window *win, SDL_Renderer *renderer, const std::string& font, int fontSize) :
    win{win},
    renderer{renderer},
    ttf_font{sdl::make_unique(TTF_OpenFont(font.c_str(), fontSize), TTF_CloseFont)},
    nk_font{
